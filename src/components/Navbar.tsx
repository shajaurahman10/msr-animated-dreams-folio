...
const Navbar = () => {
  ...
  const handleHireMe = () => {
    const subject = encodeURIComponent('Hire Me - Project Collaboration');
    const body = encodeURIComponent('Hi Mohammed,\n\nI\'m interested in hiring you for a project. I\'d love to discuss the details and see how we can work together.\n\nLooking forward to hearing from you!\n\nBest regards');
